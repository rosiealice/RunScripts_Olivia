...
casename="ihist.$resolution.$noresmversion.CPLHIST_historical_cont_1939_newlu.`date +"%Y-%m-%d"`"
...
fluh_timeseries='/cluster/work/projects/nn9560k/inputdata/LU_data_CMIP7/LUH3_timeseries_850-2024_surfdata_ne16np4_c260603.nc'
